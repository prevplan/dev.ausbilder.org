...
@section('site_title', __('user profile'))
        ...
        <div class="container-fluid">
            <div class="row">
               {{--  <div class="col-md-3">
                ...
                <!-- /.col -->
                <div class="col-md-12"> {{-- normally 9 --}}
                    <div class="card">
                                ...
                                <div class="active tab-pane" id="calendar">
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            <label for="inputApiCode" class="col-sm-2 col-form-label">API Code &nbsp; <a href="{{ route('api.regenerate') }}"><i class="fas fa-sync"></i></a></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputApiCode" value="{{ Auth::user()->api_code }}" placeholder="{{ __('regenerate to change') }}">
                                            </div>
                                        </div>
                                        @if(session('company'))
                                            <div class="form-group row">
