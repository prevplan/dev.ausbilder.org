        ...
        <div class="card-body login-card-body">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="input-group mb-3">
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" placeholder="{{ t('E-Mail Address') }}" required autocomplete="email" autofocus>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block">{{ t('Reset Password') }}</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
